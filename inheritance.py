...
print(f"Is my daily driver is a car? {isinstance(daily_driver, Car)}")
print(f"Is my truck is a Vehicle? {isinstance(truck, Vehicle)}")
print(f"Is my truck is a Car? {isinstance(truck, Car)}")
